...
<div>
    ...
    <ol>
        <li>
            <p>
                <code>从 授权服务器 获取 'code'</code>
                <br/>
                -- 该步骤将根据从 授权服务器 中获取的client信息(如appNum,appSecretKey)将用户引导到server的登录页面.
                <br/>
        ...
        <li>
            <p>
                ...
                <br/>
                -- 在server端当用户登录成功并授权后将返回到spring-oauth-client的回调地址(即redirect_url),
                <br/>
        ...
        <li>
            <p>
                <code>用 'access_token' 去访问 授权服务器 的API</code>
                <br/>
                -- 在成功获取access_token后,将根据 授权服务器 中提供的API去获取 资源服务器 中的数据.
                <br/>
        ...
        <div ng-controller="AuthorizationCodeCtrl" class="col-md-10">
            ...
            <form action="authorization_code" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">authorizationUrl</label>
                    ...
                    <div class="col-sm-10">
                        ...
                        <p class="help-block">
                            authorizationUrl value from 'spring-oauth-client.properties'
                        </p>
                    </div>
                </div>
                ...
                <div ng-show="visible">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <p class="help-block">
                                redirect_url 是在 'AuthorizationCodeController.java' 中定义的一个 URL, 用于检查server端返回的
                    ...
                    <div class="well well-sm">
                        ...
                        <div class="text-primary">
                            {{userAuthorizationUri}}?responseType={{responseType}}&scope={{scope}}&appNum={{clientId}}&redirectUrl={{redirectUri}}&state={{state}}
                        </div>
                    </div>
                </div>
                <br/>
                <br/>
                <button type="submit" class="btn btn-primary">去授权</button>
                <span class="text-muted">将重定向到 '授权' 的登录页面</span> <span
